...
Struct = (function() {
  ...
  function Struct(format, fill, encoding) {
    var count, fmt, i, offset, _i, _j, _len, _ref;
    this.format = format;
    this.fill = fill != null ? fill : null;
    this.encoding = encoding != null ? encoding : 'binary';
    this.fmts = [];
    offset = 0;
    if (format[0] === '>') {
      this.endian = 'BE';
      ...
      for (i = _i = 0; 0 <= count ? _i < count : _i > count; i = 0 <= count ? ++_i : --_i) {
        ...
        switch (fmt) {
          ...
          case 'd':
            ...
            break;
          case 's':
            buff.write(value, offset, Math.min(value.length, size), this.encoding);
            break;
          case '=':
      ...
      for (_i = 0, _len = fmts.length; _i < _len; _i++) {
        ...
        switch (fmt) {
          ...
          case 'h':
            ...
            break;
          case 'H':
            results.push(buff.readUInt16(offset));
            break;
          case 'i':
          ...
          case 'd':
            ...
            break;
          case 's':
            results.push(buff.toString(this.encoding, offset, offset + size));
            break;
          case '=':
